    ...
    >
      ...
      <div className="relative z-10">
        <div className="mb-4 flex items-start justify-between">
          <div>
            <h4 className="font-semibold text-white font-heading text-lg">{pool.name}</h4>
            <p className="mt-1 text-sm text-slate-400">APY <span className="text-cyan-400 font-semibold">{pool.apy.toFixed(1)}%</span></p>
          </div>
          <Link href={`/pools/${pool.id}`} className="text-cyan-400 hover:text-cyan-300 hover:scale-110 transition-transform">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Staked</p>
              <p className="mt-2 text-2xl font-bold text-white font-mono">{position.stakedAmount.toFixed(2)}</p>
            ...
            >
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Rewards</p>
              <p className="mt-2 text-2xl font-bold gradient-text-2">
          ...
          <div className="border-t border-slate-700/50 pt-3">
            ...
            <p className="mt-2 text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-300">{position.claimedRewards.toFixed(2)} SOL</p>
          </div>
        </div>
      </div>
    </motion.div>
